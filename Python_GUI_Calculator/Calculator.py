...
if __name__=="__main__":
    ...
    #Operator Buttons
    add = Button(root, text='+', fg='black', bg='red', command=lambda: press('+'), height=1, width=7)
    add.grid(row=2, column=3)
    mins = Button(root, text='-', fg='black', bg='red', command=lambda: press('-'), height=1, width=7)
    mins.grid(row=3, column=3)
    multi = Button(root, text='*', fg='black', bg='red', command=lambda: press('*'), height=1, width=7)
    multi.grid(row=4, column=3)
    div = Button(root, text='/', fg='black', bg='red', command=lambda: press('/'), height=1, width=7)
    div.grid(row=5, column=3 )

    #Other Buttons
    eql = Button(root, text='equal', fg='black', bg='red', command= equal, height=1, width=7)
    eql.grid(row=6, column=0)
